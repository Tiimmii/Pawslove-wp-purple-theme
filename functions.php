<?php
/**
 * pawslove functions and definitions
 *
 ...
 */
function pawslove_setup() {
	/*
		* Make theme available for translation.
		* Translations can be filed in the /languages/ directory.
		* If you're building a theme based on pawslove, use a find and replace
		* to change 'pawslove' to the name of your theme in all the template files.
		*/
	load_theme_textdomain( 'pawslove', get_template_directory() . '/languages' );
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'pawslove' ),
		)
	);
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'pawslove_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'pawslove_setup' );
 ...
 */
function pawslove_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'pawslove_content_width', 640 );
}
add_action( 'after_setup_theme', 'pawslove_content_width', 0 );
 ...
 */
function pawslove_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'pawslove' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'pawslove' ),
...
add_action( 'widgets_init', 'pawslove_widgets_init' );
...
function pawslove_scripts() {
	...
	wp_enqueue_script( 'bootstrap-popper-script', 'https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.8/dist/umd/popper.min.js', array('jquery'), _S_VERSION, true );
	wp_enqueue_script( 'bootstrap-script', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.min.js', array(), _S_VERSION, true );
